...
function make_xlsx_lib(e) {
    ...
    function Ga(e, r, t, a, n, i) {
        ...
        n.Target = t;
        if (i) n.TargetMode = i;
        else if (Xa.indexOf(n.Type) > -1) n.TargetMode = "External";
                ...
                for (E = 0; E != d.length; ++E) {
                    ...
                    switch (d[E].type) {
                        case "C":
                            ...
                            break;
                        case "D":
                            if (w.length === 8) a[m][E] = new Date(+w.slice(0, 4), +w.slice(4, 6) - 1, +w.slice(6, 8));
                            else a[m][E] = w;
                            break;
                        case "F":
    ...
    function il(e, r, t) {
        ...
        if (a.Type) nl(e, r - 2, a);
        else al(e, t.biff >= 8 ? r : r - 2, t, a);
        return a
    }
    var sl = function () {
        function e(e, t) {
    ...
    function ph(e, r, t, a, n, i) {
        ...
        if (!a || a.cellText !== false) try {
            ...
            if (e.t === "e") e.w = e.w || Aa[e.v];
                ...
                else e.w = D._general(e.v, oh)
            } else if (e.t === "d") e.w = D.format(r, ee(e.v), oh);
            else e.w = D.format(r, e.v, oh)
        } catch (s) {
            if (a.WTF) throw s
        }
    ...
    function xh(e, r, t, a, n, i, s) {
        ...
        var w = c.match(gh);
        if (w)
            for (d = 0; d != w.length; ++d) k[d] = kt(w[d].slice(w[d].indexOf('"') + 1));
        var S = c.match(kh);
        if (S) Oh(f, S, a);
        var B = c.match(Ch);
                ...
                for (v = 0; v != b.length; ++v) {
                    ...
                    if (c.cellFormula) {
                        ...
                        for (E = 0; E < F.length; ++E)
                            if (j.r >= F[E][0].s.r && j.r <= F[E][0].e.r)
                                if (j.c >= F[E][0].s.c && j.c <= F[E][0].e.c) S.F = F[E][1]
                    }
    ...
    function sp(e) {
        ...
        if (typeof Uint8Array !== "undefined" && e instanceof Uint8Array) return Ye(x(y(e)));
    ...
    function lp(e, r) {
        ...
        while (s = fp.exec(a)) switch (s[3] = (K = s[3]).toLowerCase()) {
            ...
            case "font":
                ...
                else if (s[1] === "/") _ += a.slice(x, s.index);
            ...
            case "appname":
                if (s[0].slice(-2) === "/>") break;
                else if (s[1] === "/") mn(y, K, a.slice(R, s.index));
            ...
            default:
                ...
                if (f[f.length - 1][0] === "customdocumentproperties") {
                    if (s[0].slice(-2) === "/>") break;
                    else if (s[1] === "/") rp(I, K, F, a.slice(R, s.index));
                    else {
                        F = s;
    ...
    function bp(e, r, t, a) {
        ...
        if (a && a.Workbook && a.Workbook.Sheets && a.Workbook.Sheets[t]) {
            if (a.Workbook.Sheets[t].Hidden) n.push(or("Visible", a.Workbook.Sheets[t].Hidden == 1 ? "SheetHidden" : "SheetVeryHidden", {}));
            else {
                for (var i = 0; i < t; ++i)
        ...
        while (e.l < e.length - 1) {
            ...
            if (q && q.f) {
                ...
                case "Formula": {
                    ...
                    if (r.cellFormula) {
                        ...
                        if (le && le[0] && le[0][0] && le[0][0][0] == "PtgExp") {
                            ...
                            if (E[ue]) w.f = "" + Hu(re.formula, s, re.cell, W, R);
                            else w.F = ((r.dense ? (n[oe] || [])[ce] : n[ue]) || {}).F
                ...
                default:
                    ...
                    break;
                    case "CodeName": {
                        if (!c) _.WBProps.CodeName = re || "ThisWorkbook";
    ...
    function Rp(e, r) {
        ...
        if (r.bookProps && !r.bookSheets) n = {};
            ...
            else if ((i = V.find(e, "PerfectOffice_MAIN")) && i.content) n = gf.to_workbook(i.content, (r.type = f, r));
            else if ((i = V.find(e, "NativeContent_MAIN")) && i.content) n = gf.to_workbook(i.content, (r.type = f, r));
    ...
    function Vp(e, r, t, a) {
        if (r.v != null) switch (r.t) {
            ...
            case "n":
                ...
                if (n == (n | 0) && n >= 0 && n < 65536) Mp(e, 2, lf(t, a, n));
                else Mp(e, 3, sf(t, a, n));
                return;
            case "b":
                ;
            case "e":
    ...
    function Qp(e, r, t, a, n) {
        ...
        if (r.bf) Mp(e, "Formula", Ku(r, t, a, n, i));
        else switch (r.t) {
            case "d":
                ;
            case "n":
        ...
        for (; v < f.length && p < l; ++v) {
            ...
            for (m = g = 0; m < S.length; ++m) {
                ...
                if (C != null) {
                    ...
                    else if (a.raw || C.trim().length == 0 || A == "s") {} else if (C === "TRUE") x = {
                        t: "b",
                        v: true
                    };
                    else if (C === "FALSE") x = {
                ...
                case "数据":
                    if (E[0].charAt(E[0].length - 2) === "/") {
                        ...
                        if (i.cellFormula) {
                            ...
                            if (w.formula) k.f = nh(w.formula);
                            else
                                for (K = 0; K < L.length; ++K)
                                    if (_ >= L[K][0].s.r && _ <= L[K][0].e.r)
                                        if (x >= L[K][0].s.c && x <= L[K][0].e.c) k.F = L[K][1]
                        }
    ...
    function Rb(e, r) {
        ...
        if (r && r.bookVBA) {
            if (a.vba.length > 0) v.vbaraw = we(e, Ib(a.vba[0]), true);
            else if (a.defaults && a.defaults.bin === Qo) v.vbaraw = we(e, "xl/vbaProject.bin", true)
        }
        return v
    }
    ...
    function Vb(e, r) {
        o();
        if (typeof ArrayBuffer !== "undefined" && e instanceof ArrayBuffer) return Vb(new Uint8Array(e), r);
        var t = e,
            a = [0, 0, 0, 0],
            n = false;
        var i = r || {};
